...
void setup()
{
  ...
  if ((parsing_result(IndoreCondition)) == 1) {
    ...
    Serial.println(IndoreCondition["current_observation"]["temp_c"].as<char*>());
    Serial.println("Weather");
    Serial.println(IndoreCondition["current_observation"]["weather"].as<char*>());
    Serial.println("Humidity");
    Serial.println(IndoreCondition["current_observation"]["relative_humidity"].as<char*>());
